...
public class KLeagueMatchCrawler implements MatchCrawler {
    ...
    private static final String API_URL_TEMPLATE =
            "https://api-gw.sports.naver.com/schedule/games?fields=basic,schedule,league,leagueName" +
                    "&upperCategoryId=kfootball&categoryId=kleague&fromDate=%s&toDate=%s";
    ...
    public void crawl(LocalDateTime recentTime) {
        ...
        log.info("K리그 API 호출: {}", requestUrl);
